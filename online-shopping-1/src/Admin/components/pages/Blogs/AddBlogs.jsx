...
export default function AddBlogs() {
    return (
        <div className='addBlogs-main'>
            <Helmet>
                <title>
                    Online Shopping - Admin - Add Blog Page
                </title>
            </Helmet>
            <div className="addBlogs-container pt-2">
                <p className="addBlogs-heading fw-bold py-2 ps-4">Add Blog</p>
            </div>
            <div className="input-main-container mt-4 mx-3 bg-white border rounded-3 p-4">
                <form className="row g-3">
                    ...
                    <div className="col-md-6 mb-3">
                        <label htmlFor="formFile" className="form-label fw-semibold">Blog Image</label>
